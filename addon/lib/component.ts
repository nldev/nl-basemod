// import '../global'
//
export type Component<O = any, C extends WoWAPI.UIObject = WoWAPI.Frame> = ($: Container, options: O) => C
...
export const Button: Component = ($: Container, options: any) => {
...
// }
//
// export interface ComponentOptions<T extends Component = Component> {
//   size: Size
//   parent?: T | 'root'
//   name?: string
//   isPrefix?: boolean
...
// }
//
// export abstract class Component<T = any, O extends ComponentOptions = ComponentOptions> {
//   public frame: T
//   public size: Size
//
...
//       (parent === 'root') ? this.ui.root.frame : parent.frame,
//       inherits,
//       id,
//     )
//
...
//     } else if (relativeTo === PARENT && this.options.parent) {
//       this.frame.SetAllPoints(this.options.parent.frame)
//     } else {
